            ...
            <header id="header">
                <div class="header-left hidden-lg hidden-md hidden-sm">
                    ...
                    <div class="navbar-header">
                        <!-- Start brand -->
                        <a class="navbar-brand" style="font-size: 12px" href="./"> 播客设计 </a
                        ><!-- /.navbar-brand -->
                        <!--/ End brand -->
                    </div>
                    <!-- /.navbar-header -->
                        ...
                        <div class="dropdown navbar-profile">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <span class="meta">
                                    ...
                                    <span class="text hidden-xs hidden-sm text-muted"><%= session.getAttribute("username") !=null ? session.getAttribute("username") : "" %></span>
                    ...
                    <div class="navbar navbar-toolbar navbar-success">
                        ...
                        <a href="javascript:void(0);" title="Minimize sidebar">
                            ...
                            <li class="navbar-search">
                                ...
                                <span class="navbar-brand" href="./" style="color: #ffffff"> 播客设计 </span>
                            </li>
                            <!--/ End form search -->
                        </ul>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown navbar-profile">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <span class="meta">
                                        <span class="avatar"><% if (session.getAttribute("touxiang") != null && session.getAttribute("touxiang") != "") { %>

                            <img src="<%= session.getAttribute("touxiang") !=null ? session.getAttribute("touxiang") : "" %>" alt="admin" />
                            <%} else { %>
                ...
                <div class="sidebar-content">
                    <div class="media">
                        <a class="pull-left has-notif avatar" href="javascript:;">
                            <% if (session.getAttribute("touxiang") != null && session.getAttribute("touxiang") != "") { %>
                        ...
                        <div class="media-body">
                            <h4 class="media-heading"><span><%= session.getAttribute("username") !=null ? session.getAttribute("username") : "" %></span></h4>
                            <small><%= session.getAttribute("cx") !=null ? session.getAttribute("cx") : "" %></small>
                        </div>
                    </div>
                </div>
                <!-- /.sidebar-content -->
