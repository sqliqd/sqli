    ...
    <nav class="navbar navbar-default-lan">
        <div class="container container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"> 播客设计 </a>
            </div>
                ...
                <ul class="nav navbar-nav" id="navbar-str">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <% List<Map> mapshipinleixing1 = new CommDAO().select("SELECT id,fenleimingcheng FROM shipinleixing"); %>
 <% for (Map m : mapshipinleixing1) { %>

                            <li><a href="shipinxinxilist.jsp?fenlei=<%= m.get("id") %>"><%= m.get("fenleimingcheng") %></a></li>
                            <%} %>
                ...
                <form class="navbar-form navbar-right" action="shipinxinxilist.jsp">
