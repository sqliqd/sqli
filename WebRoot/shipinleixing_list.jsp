...
List<Map> lists = Query.make("shipinleixing").where(where).order(orderby + " " + sort).page(15);
%>
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr id="<%= map.get("id") %>" pid="">
                            ...
                            <td align="center">
                                <a class="btn btn-success btn-xs" href="shipinleixing_updt.jsp?id=<%= map.get("id") %>" title="编辑"> 编辑 </a>

                                <a
                                    class="btn btn-danger btn-xs"
                                    href="shipinleixing.jsp?a=delete&id=<%= map.get("id") %>"
