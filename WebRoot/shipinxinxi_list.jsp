...
-<%} else { %><img width="100" src="<%= map.get("fengmian") %>" /><%} %>
                            ...
                            <td><% Map mapshipinleixing3 = new CommDAO().find("SELECT fenleimingcheng,id FROM shipinleixing where id='" + map.get("fenlei") + "'"); %>
<%= mapshipinleixing3.get("fenleimingcheng") %></td>
