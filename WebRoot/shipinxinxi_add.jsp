...
<div>
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="shipinxinxi.jsp?a=insert" method="post" name="form1" id="form1">
                <!-- form 标签开始 -->
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <select
                                class="form-control class_fenlei8"
                                data-value=""
                                data-rule-required="true"
 ...
 <% for (Map m : select) { %>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group" style="width: 250px">
                                <input type="text" class="form-control" data-rule-required="true" data-msg-required="请填写视频" id="shipin" name="shipin" value="" />
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group" style="width: 250px">
                                <input type="text" class="form-control" id="wenjian" name="wenjian" value="" />
